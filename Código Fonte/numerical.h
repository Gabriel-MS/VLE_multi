...
double Maxwell_cons(vector<double>& rho, vector<double>& P, double P1)
{
    ...
    std::vector<double> dPdV(1000), rho_a1(100), rho_a2(100), P_a1(100), P_a2(100);
    int SIZE, i;
    ...
    rho1 = falsi_spline(rho, P, rho[0], rho_max, 1e-3);
    rho2 = falsi_spline(rho, P, rho_max, rho_min, 1e-3);
    rho3 = falsi_spline(rho, P, rho_min, rho[SIZE], 1e-3);
    ...
    Area1 = simpson_rule(rho_a1, P_a1, 100);
    Area1 = Area1 - P1*(rho2-rho1);

    Area2 = P1*(rho3-rho2);
    Area2 = Area2 - simpson_rule(rho_a2, P_a2, 100);
    ...
    cout << "rho2 = " << rho2 << endl;
    cout << "rho3 = " << rho3 << endl;
    cout << "Area1 pre = " << simpson_rule(rho_a1, P_a1, 100) << endl;
...
vector<double> dens_maxwell(vector<double>& rho, vector<double>& P)
{
    ...
    Pz = zbrentm(Maxwell_cons, P1, P2, 1e-3, rho, P);
    ...
    //Find density roots for pressure using Regula Falsi method
    rho1 = falsi_spline(rho, P, rho[0], rho_max, 1e-3);
    rho2 = falsi_spline(rho, P, rho_min, rho[SIZE], 1e-3);
...
>>>>>>> becc98e5de993fe72dd23867aa0683b35bf50468
